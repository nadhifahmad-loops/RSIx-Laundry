...
import { Rabbit, Clock, CheckCheck, ArrowLeft, Sparkles, Phone, ChevronRight } from "lucide-react";
...
export default function BonekaPage() {
  ...
  const features = [
    "Dicuci dengan metode dry cleaning untuk boneka",
    "Deterjen lembut aman untuk boneka",
    "Mengembalikan warna dan kelembutan",
    "Sterilisasi dari kuman dan tungau",
    "Tidak merusak isi dan jahitan",
    "Kembali bersih, wangi, dan lembut",
  ];

  const steps = [
    { icon: "1", title: "Titip Boneka", desc: "Serahkan boneka ke outlet atau dijemput" },
    { icon: "2", title: "Inspeksi", desc: "Kami periksa bahan dan kondisi boneka" },
    { icon: "3", title: "Cuci Khusus", desc: "Diproses dengan metode lembut & aman" },
    { icon: "4", title: "Kembali", desc: "Dikembalikan bersih dan wangi" },
  ];
    ...
    <div ref={sectionRef}>
      <section className="relative pt-28 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="detail-fade flex items-center gap-2 text-sm text-white/60 mb-6">
            ...
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="text-white">Cuci Boneka</span>
          </div>
          ...
          <p className="detail-fade text-lg text-white/80 max-w-2xl mb-8">
            Boneka favorit Anda dibersihkan dengan metode khusus yang aman dan lembut. 
            Cocok untuk semua jenis boneka dari berbagai ukuran dan bahan.
          </p>
          ...
          <div className="detail-fade flex flex-wrap gap-3 mb-6">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 backdrop-blur-sm px-4 py-2 text-sm font-medium text-white ring-1 ring-white/20">
              <Clock className="h-4 w-4" /> 2-4 Hari
            </span>
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 backdrop-blur-sm px-4 py-2 text-sm font-medium text-white ring-1 ring-white/20">
          ...
          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20Boneka"
            target="_blank"
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
        <div className="detail-fade rounded-2xl bg-gradient-to-br from-primary to-secondary p-8 sm:p-10 text-white shadow-xl mb-16">
          ...
          <p className="text-4xl sm:text-5xl font-bold mb-2">Rp30.000<span className="text-xl font-normal opacity-80">/buah</span></p>
          <p className="opacity-80 mb-6">Harga tergantung ukuran boneka</p>
          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20Boneka"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <section className="detail-fade mb-16">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0F172A] mb-4">Tentang Cuci Boneka</h2>
              <p className="text-[#475569] leading-relaxed mb-4">
                Boneka favorit Anda menyimpan banyak debu, kuman, dan tungau yang tidak terlihat. Mencuci boneka sendiri seringkali berisiko merusak isi, jahitan, atau bentuknya. Kami menawarkan jasa cuci boneka profesional dengan metode dry cleaning khusus yang lembut namun efektif.
              </p>
              <p className="text-[#475569] leading-relaxed">
                Proses pencucian dilakukan dengan deterjen lembut yang aman untuk boneka, tanpa merusak warna, isi, maupun detail jahitan. Boneka Anda akan kembali bersih, wangi, lembut, dan steril dari kuman — aman untuk anak-anak maupun koleksi kesayangan Anda.
              </p>
            </div>
            <div className="flex-1 w-full">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                <Image src="https://images.unsplash.com/photo-1597645587822-e99fa5d45d25?w=600&q=80" alt="Cuci Boneka" fill className="object-cover" sizes="50vw" />
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="detail-fade rounded-2xl bg-[#F8FAFC] p-8 sm:p-10 text-center ring-1 ring-gray-100 mb-16">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mb-3">Boneka kesayangan perlu dicuci?</h2>
          <p className="text-[#475569] mb-6">Percayakan pada ahlinya</p>
          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20Boneka"
            target="_blank"
            rel="noopener noreferrer"
