...
import { Footprints, Clock, CheckCheck, ArrowLeft, Sparkles, Phone, ChevronRight } from "lucide-react";

export default function LaundrySepatuPage() {
  ...
  const features = [
    "Dicuci dengan sikat khusus",
    "Menggunakan shampoo sepatu premium",
    "Menghilangkan bau dan noda membandel",
    "Dijemur dengan metode anti jamur",
    "Kembali wangi seperti baru",
    "Aman untuk semua jenis bahan sepatu",
  ];

  const steps = [
    { icon: "1", title: "Titip Sepatu", desc: "Serahkan sepatu ke outlet atau dijemput" },
    { icon: "2", title: "Inspeksi", desc: "Kami periksa kondisi dan jenis bahan" },
    { icon: "3", title: "Cuci", desc: "Dicuci dengan teknik khusus per jenis sepatu" },
    { icon: "4", title: "Siap Pakai", desc: "Dikembalikan bersih dan wangi" },
  ];
    ...
    <div ref={sectionRef}>
      <section className="relative pt-28 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="detail-fade flex items-center gap-2 text-sm text-white/60 mb-6">
            ...
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="text-white">Laundry Sepatu</span>
          </div>
          ...
          <p className="detail-fade text-lg text-white/80 max-w-2xl mb-8">
            Kembalikan sepatu kesayangan Anda seperti baru. Menggunakan teknik pencucian khusus 
            dan shampoo premium yang aman untuk semua jenis material sepatu.
          </p>
          ...
          <div className="detail-fade flex flex-wrap gap-3 mb-6">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 backdrop-blur-sm px-4 py-2 text-sm font-medium text-white ring-1 ring-white/20">
              <CheckCheck className="h-4 w-4" /> Per Pasang
            </span>
          </div>

          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20tanya%20tentang%20Laundry%20Sepatu"
            target="_blank"
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
        <div className="detail-fade rounded-2xl bg-gradient-to-br from-primary to-secondary p-8 sm:p-10 text-white shadow-xl mb-16">
          ...
          <p className="text-4xl sm:text-5xl font-bold mb-2">Rp35.000<span className="text-xl font-normal opacity-80">/pasang</span></p>
          <p className="opacity-80 mb-6">Harga tergantung jenis dan kondisi sepatu</p>
          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20sepatu"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <section className="detail-fade mb-16">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0F172A] mb-4">Tentang Laundry Sepatu</h2>
              <p className="text-[#475569] leading-relaxed mb-4">
                Mencuci sepatu tidak bisa sembarangan. Setiap jenis sepatu membutuhkan metode dan produk pembersih yang berbeda. Laundry sepatu kami menggunakan teknik khusus dan shampoo premium yang aman untuk semua jenis material — mulai dari kanvas, kulit, suede, hingga mesh.
              </p>
              <p className="text-[#475569] leading-relaxed">
                Tim kami akan menginspeksi kondisi sepatu Anda terlebih dahulu, membersihkan noda membandel, mencuci dengan sikat khusus, dan mengeringkan dengan metode anti jamur. Hasilnya, sepatu Anda kembali bersih, wangi, dan terawat seperti baru.
              </p>
            </div>
            <div className="flex-1 w-full">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                <Image src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=600&q=80" alt="Laundry Sepatu" fill className="object-cover" sizes="50vw" />
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="detail-fade rounded-2xl bg-[#F8FAFC] p-8 sm:p-10 text-center ring-1 ring-gray-100 mb-16">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mb-3">Sepatu kotor? Kami siap bantu!</h2>
          <p className="text-[#475569] mb-6">Hubungi kami untuk konsultasi gratis</p>
          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20sepatu"
            target="_blank"
            rel="noopener noreferrer"
