...
import { Layers, Clock, CheckCheck, ArrowLeft, Sparkles, Phone, ChevronRight } from "lucide-react";

export default function KarpetPage() {
  ...
  const features = [
    "Mesin khusus kapasitas besar",
    "Deterjen dan shampoo karpet premium",
    "Membersihkan debu, noda, dan bau",
    "Sterilisasi kuman dan tungau",
    "Dijemur dengan metode khusus",
    "Kembali bersih maksimal dan wangi",
  ];

  const steps = [
    { icon: "1", title: "Pesan", desc: "Hubungi kami, kami siap jemput karpet" },
    { icon: "2", title: "Inspeksi", desc: "Periksa jenis dan ukuran karpet" },
    { icon: "3", title: "Cuci Khusus", desc: "Diproses dengan metode dan mesin khusus" },
    { icon: "4", title: "Antar", desc: "Diantar kembali bersih dan wangi" },
  ];
    ...
    <div ref={sectionRef}>
      <section className="relative pt-28 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="detail-fade flex items-center gap-2 text-sm text-white/60 mb-6">
            ...
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="text-white">Cuci Karpet</span>
          </div>
          ...
          <p className="detail-fade text-lg text-white/80 max-w-2xl mb-8">
            Layanan cuci karpet profesional dengan mesin dan deterjen khusus. 
            Cocok untuk karpet rumah, kantor, dan masjid dengan berbagai ukuran.
          </p>
          ...
          <div className="detail-fade flex flex-wrap gap-3 mb-6">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 backdrop-blur-sm px-4 py-2 text-sm font-medium text-white ring-1 ring-white/20">
              <Clock className="h-4 w-4" /> 3-5 Hari
            </span>
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 backdrop-blur-sm px-4 py-2 text-sm font-medium text-white ring-1 ring-white/20">
              <CheckCheck className="h-4 w-4" /> Per Ukuran
            </span>
          </div>

          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20Karpet"
            target="_blank"
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
        <div className="detail-fade rounded-2xl bg-gradient-to-br from-primary to-secondary p-8 sm:p-10 text-white shadow-xl mb-16">
          ...
          <p className="text-4xl sm:text-5xl font-bold mb-2">Rp50.000<span className="text-xl font-normal opacity-80">/karpet</span></p>
          <p className="opacity-80 mb-6">Harga tergantung ukuran dan jenis karpet</p>
          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20Karpet"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <section className="detail-fade mb-16">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0F172A] mb-4">Tentang Cuci Karpet</h2>
              <p className="text-[#475569] leading-relaxed mb-4">
                Karpet menjadi salah satu barang paling sulit dibersihkan di rumah. Debu, noda, dan kuman yang menempel bisa membuat karpet cepat rusak dan menjadi sumber alergi. Kami menyediakan jasa cuci karpet profesional dengan mesin khusus dan shampoo karpet premium.
              </p>
              <p className="text-[#475569] leading-relaxed">
                Proses pencucian meliputi pembersihan debu dengan vacuum industri, pencucian dengan shampoo karpet, sterilisasi kuman dan tungau, serta pengeringan dengan metode khusus. Karpet Anda akan kembali bersih maksimal, wangi, dan segar. Cocok untuk karpet rumah, kantor, dan masjid.
              </p>
            </div>
            <div className="flex-1 w-full">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                <Image src="https://images.unsplash.com/photo-1601158935946-522d96e19c0f?w=600&q=80" alt="Cuci Karpet" fill className="object-cover" sizes="50vw" />
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="detail-fade rounded-2xl bg-[#F8FAFC] p-8 sm:p-10 text-center ring-1 ring-gray-100 mb-16">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mb-3">Karpet butuh dicuci?</h2>
          <p className="text-[#475569] mb-6">Kami siap membersihkan karpet Anda</p>
          <a
            href="https://wa.me/6281234567890?text=Halo%20RSix%20Laundry%2C%20saya%20ingin%20cuci%20Karpet"
            target="_blank"
            rel="noopener noreferrer"
